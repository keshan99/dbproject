...
exports.isLoggedIn = async(req, res, next) => {
    if (req.cookies.jwt) {
        try {
            ...
            const decoed = await promisify(jwt.verify)(
                req.cookies.jwt,
            ...
            db.query(
                "SELECT * FROM user WHERE ID = ?", [decoed.id],
                (error, result) => {
                    console.log(result);
    ...
    try {
        ...
        db.query(
            ...
            (error, result) => {
                ...
                db.query(
                    "UPDATE user SET F_name = ?, M_name = ?, L_name = ?, Email = ?, DOB = ?, gender = ?, batch = ?, department = ?, city = ? WHERE ID=?", [
                        Fname,
                        Mname,
                        Lname,
                        email,
