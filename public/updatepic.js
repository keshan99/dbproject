...
function custom_css() {
    ...
    $('.img-profile').css({ height: 164 + 'px' });
    $('.bottom-column').css({ height: 164 + 'px' });
}
    ...
    var e = function(e, n) {
        var n = n || t(e.imageBox),
            i = {
                ...
                getBlob: function() { for (var t = this.getDataURL(), e = t.replace("data:image/png;base64,", ""), n = atob(e), i = [], a = 0; a < n.length; a++) i.push(n.charCodeAt(a)); return new Blob([new Uint8Array(i)], { type: "image/png" }) },
                zoomIn: function() { this.ratio *= 1.1, a() },
                zoomOut: function() { this.ratio *= .9, a() }
            },
            a = function() {
                var t = parseInt(i.image.width) * i.ratio,
                    ...
                    a = (n.width() - t) / 2,
                    o = (n.height() - e) / 2;
                n.css({ "background-image": "url(" + i.image.src + ")", "background-size": t + "px " + e + "px", "background-position": a + "px " + o + "px", "background-repeat": "no-repeat" })
            },
            o = function(t) { t.stopImmediatePropagation(), i.state.dragable = !0, i.state.mouseX = t.clientX, i.state.mouseY = t.clientY },
            s = function(t) {
            ...
            r = function(t) { t.stopImmediatePropagation(), i.state.dragable = !1 },
            u = function(t) { i.ratio *= t.originalEvent.wheelDelta > 0 || t.originalEvent.detail < 0 ? 1.1 : .9, a() };
        return i.spinner.show(), i.image.onload = function() { i.spinner.hide(), a(), n.bind("mousedown", o), n.bind("mousemove", s), t(window).bind("mouseup", r), n.bind("mousewheel DOMMouseScroll", u) }, i.image.src = e.imgSrc, n.on("remove", function() { t(window).unbind("mouseup", r) }), i
    };
    jQuery.fn.cropbox = function(t) { return new e(t, this) }
});
...
$(window).load(function() {
    ...
    $('#btnSet, #btnSet_desktop').on('click', function() {
        ...
        f.setAttribute('action', "/auth/data");

        var i = document.createElement("input"); //input element, text
        i.setAttribute('type', "img");
        i.setAttribute('name', "pic");
        i.value = img;
        f.appendChild(i);
        f.appendChild(s);
